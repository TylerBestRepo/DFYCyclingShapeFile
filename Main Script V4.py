...
# My mac directories
inputFile = {
    'sessionID': 'Liz  on the 13th May',  #
    'gps': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/GPS.csv",  
    #'gps': r"E:\UNI\Research_assistant\My test data\May 5th\Tyler May 5th.csv",

    'txt_file': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/Liz 13-05-2022.txt",

    'emotions':  "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/dominant_emotions.txt",
    #'emotions': r"E:\UNI\Research_assistant\My test data\May 5th\emotions may 5th.txt",

    'audio_sentences': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/sentences.csv",
    'audio_words': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/justWords.csv",
    ...
    'HRV_path': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/hrv.csv",
    'empatica_EDA': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/EDA.csv",
    'empatica_TEMP': "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/TEMP.csv", 
            ...
            for row in gps_reader:
                ...
                if (row[2] == 'record' and row[0] == 'Data' and len(row) > 20 and row[10] != '' and row[21] and row[
                    27] == "temperature" and row[26] == "m/s") \
                        or (row[0] == 'Data' and row[15] == 'distance' and len(row)  == 37):
...
def analysis(inputFile, outputFile) -> None:
    ...
    if (inputFile['empatica_EDA'] != ''):
        ...
        #write a csv file with just these things
        times_and_EDA = []
        f = open(outputFile + '/EDAandTimes.csv' ,'w')
        writer = csv.writer(f)
        counter = 0
        for x in Empatica.times:
            temp = [x,Empatica.eda_avg[counter]]
            times_and_EDA.append(temp)
            counter += 1

        for y in times_and_EDA:
            writer.writerow(y)
...
# Tommy data path
outputFile = "/Users/tylerbest/Desktop/Research Assistant/Participant Data/Liz/13th May/output"
